...
public class Car { 
	...
	//four argument constructor for object Car
	...
	public Car() { //no argument/default constructor for Car
		...
		//getters and setters for above the instance values so that other classes in this package can access them (since they're private)		
	    //getter for make
